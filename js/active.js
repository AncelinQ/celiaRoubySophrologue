...
$(function () {
    ...
    var adresse = window.location.href.substr(
    ...
    $("#headerNav ul li a").each(function () {
        ...
        if (
            adresse === "violences.php" ||
            adresse === "rapport-au-corps.php" ||
            adresse === "gestion-de-la-douleur.php"
        ) {
            $("#specialisationsNav > a").addClass("active");
        }
        //MEME CHOSE ICI SAUF QU'IL S'AGIT DE DIFFÉRENTES SECTIONS D'UNE MEME PAGE//
        if (
            adresse === "infos-pratiques.php#tarifs" ||
            adresse === "infos-pratiques.php#seances" ||
            adresse === "infos-pratiques.php#cabinet"
        ) {
